      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">รายงานรายได้บริการทั่วไป</h1>
           ...
           <div class="col-md-6">
            <form name="form1" method="POST" action="receiptevent.php">
                    ...
                    <table id="datatablesSimple">
                       ...
                       <?php
                            ...
                            if (($ddt1 != "") && ($ddt2 != "")) {
                                ...
                                $pic = mysqli_query($conn, "SELECT * FROM `events` WHERE status='1' AND start BETWEEN '$ddt1' AND '$ddt2' ORDER BY start DESC");
                            } else {
                                $pic = mysqli_query($conn, "SELECT * FROM `events` WHERE status='1'");
                            }
