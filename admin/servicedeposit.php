...
if (isset($_POST['submit'])) {
  ...
  $price = $_POST["price"];
    ...
    $sql = "INSERT INTO tb_servicedeposit (service, status, description, image,price) 
    ...
    <div class="row">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">ข้อมูลบริการรับฝาก</h1>
          <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <div class="modal fade" id="add_data" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                ...
                <form class="modal-content" method="post" action="servicedeposit.php" enctype="multipart/form-data">
        ...
        <div class="container-fluid px-4 mt-4 center-content">
            ...
            <div class="card mb-4 text-dark ">
                ...
                <div class="table-responsive">
                    <table id="datatablesSimple">
                        ...
                        <?php
            include 'config.php';
            $pic = mysqli_query($conn, "SELECT * FROM `tb_servicedeposit`");
            while ($row = mysqli_fetch_array($pic)) {
              echo "
                              ...
                              <td class='center-align style='white-space: nowrap; overflow: hidden;'><a href='servicedeposit_updateImage.php?id=$row[id]' class='btn btn-success bi bi-pencil-square' type='button'></a></td>
                              ...
                              <td class='center-align' style='white-space: nowrap; overflow: hidden;'><a href='servicedeposit_delete.php?id=$row[id]' class='btn btn-danger' type='button' onclick='return confirmDelete()'>ลบข้อมูล</a></td>
                              <td class='center-align style='white-space: nowrap; overflow: hidden;'><a href='servicedeposit_update.php?id=$row[id]' class='btn btn-success bi bi-pencil-square' type='button'></a></td>
