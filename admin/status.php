...
$sql1 = "SELECT COUNT(id) AS id_zero FROM events WHERE status='0'";
$hand1 = mysqli_query($conn, $sql1);
$row1 = mysqli_fetch_array($hand1);

$sql2 = "SELECT COUNT(id) AS id_one FROM events WHERE status='1'";
$hand2 = mysqli_query($conn, $sql2);
$row2 = mysqli_fetch_array($hand2);

$sql3 = "SELECT COUNT(id) AS id_two FROM events WHERE status='2'";
    ...
    <div class="container-fluid px-4">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">ข้อมูลการจองบริการทั่วไป</h1>
            ...
            <div class="card mb-4 text-dark ">
                ...
                <div class="table-responsive">
                    <table id="datatablesSimple">
                       ...
                       <?php
                          include 'config.php';
                          $pic = mysqli_query($conn, "SELECT * FROM `events`");
                          while ($row = mysqli_fetch_array($pic)) {
                              ...
                              echo "</td>
                                    ...
                                    <td class='center-align' style='white-space: nowrap;'>
                                        <a href='status_delete.php?id=$row[id]' class='btn btn-danger' type='button'>ลบข้อมูล</a>
                                    </td>
                                    <td class='center-align' style='white-space: nowrap;'>
                                        <a href='status_update.php?id=$row[id]' class='btn btn-success bi bi-pencil-square' type='button'></a>
                                    </td>
                                    </tr>";
                          }
                          ?>
