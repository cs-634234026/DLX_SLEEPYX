...
<!-- 
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2">รายงานรายได้บริการทั่วไป</h1>

           <!-- เพิ่มโค้ดแบบฟอร์มค้นหาตรงนี้ -->
           <div class="col-md-6">
            <form name="form1" method="POST" action="receiptdeposit.php">
        ...
        <div class="container-fluid px-4 mt-4 center-content">
            ...
            <div class="card mb-4 text-dark ">
                ...
                <div class="table-responsive">
                    <table id="datatablesSimple">
                       ...
                       <?php
                            ...
                            if (($ddt1 != "") && ($ddt2 != "")) {
                                ...
                                $pic = mysqli_query($conn, "SELECT * FROM `deposit` WHERE status='1' AND start BETWEEN '$ddt1' AND '$ddt2' ORDER BY start DESC");
                            } else {
                                $pic = mysqli_query($conn, "SELECT * FROM `deposit` WHERE status='1'");
                            }
                            $total_sum = 0; // ต้องเพิ่ม ; ที่นี่
                    ...
                    <br>
                    <div>รวมเป็นเงินทั้งหมด <?=$total_sum?> บาท</div>
                </div>
            </div>
        </div>
    </main>
...
$(document).ready(function() {
    $('#datatablesSimple').DataTable({
        ...
        searching: true,
        info: false,
        paging: false, // เพิ่มบรรทัดนี้เพื่อปิดการแสดงปุ่มเพจก่อนหน้า
    });
});
</script>
