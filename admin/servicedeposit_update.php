...
if(isset($_POST['id'])){
  ...
  $sql = "UPDATE tb_servicedeposit SET id = '$id', service = '$service', status = '$status', description = '$description', price = '$price' WHERE `tb_servicedeposit` .`id` = $id";
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              <button type="button" class="btn btn-secondary" onclick="window.location.href='servicedeposit.php'">ย้อนกลับ</button>
            </div>
          </div>
          <div class="row justify-content-md-center">
            <div class="col-6">
              <div class="card">
                ...
                <div class="card-body">
                  <form method="post" action="servicedeposit_update.php" >
