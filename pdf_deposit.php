...
$text_tis620 = iconv('UTF-8', 'TIS-620', 'ใบรับฝากสัตว์');
...
$text_signature = iconv('UTF-8', 'TIS-620', 'ลายเซ็นเจ้าของสัตว์: ________________________________');
$pdf->Cell(0, 10, $text_signature, 0, 1, 'R'); // ใช้ 'R' ใน Cell() เพื่อจัดตำแหน่งข้อความลายเซ็นทางขวา
$text_signature = iconv('UTF-8', 'TIS-620', ' (                                                   )');
$pdf->Cell(0, 10, $text_signature, 0, 1, 'R'); // ใช้ 'R' ใน Cell() เพื่อจัดตำแหน่งข้อความลายเซ็นทางขวา

$pdf->Cell(100); // เลื่อนตำแหน่งไปทางขวา
$text_signature = iconv('UTF-8', 'TIS-620', 'ลายเซ็นเจ้าของร้านรับรอง: ________________________________');
$pdf->Cell(0, 10, $text_signature, 0, 1, 'R'); // ใช้ 'R' ใน Cell() เพื่อจัดตำแหน่งข้อความลายเซ็นทางขวา
$text_signature = iconv('UTF-8', 'TIS-620', ' (                                                   )');
$pdf->Cell(0, 10, $text_signature, 0, 1, 'R'); // ใช้ 'R' ใน Cell() เพื่อจัดตำแหน่งข้อความลายเซ็นทางขวา
